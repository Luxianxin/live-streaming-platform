...
import org.easydarwin.easypusher.FileUtilcll;
import org.easydarwin.easypusher.ForgetPwd;
import org.easydarwin.easypusher.Https;
import org.easydarwin.easypusher.Login;
import org.easydarwin.easypusher.R;
import org.easydarwin.easypusher.ResetPwd;
...
public class UserCenterFragment extends Fragment implements View.OnClickListener{
    ...
    public static UserCenterFragment newInstance(String userName,String cookie) {
        ...
        bundle.putString("mCookie", cookie);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(getArguments() != null){
            ...
            cookie = getArguments().getString("mCookie");
        }
        AvgTime();
        TotalTime();
        TopThreeTime();
        ...
        if(!mUsername.equals(mUsernameTemp)) {
            ...
            Call<ResponseBody> call = service.getUserInfo(body);
    ...
    public interface totalTime{
        @Headers({"Content-Type: application/json","Accept: application/json"})//json
        @POST("/statistics/anchor/totalTime")
